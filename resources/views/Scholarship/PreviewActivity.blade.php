...
<div class="super_container">
                                        ...
                                        <div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
                                            <nav class="main_nav">
                                                <ul>
                                                    ...
                                                    <li class="active"><a id="login" href="/PreviewActivity">الانشطة والفعاليات</a></li>
    ...
    <div  class="intro" id="scholarship_div">
        ...
        <div  class="intro_content d-flex flex-row flex-wrap align-items-start justify-content-between" dir="rtl">
            ...
            <!-- Intro Item -->
            <div  ng-repeat="x in adverts | filter:searchText" class="intro_item pull-right" ng-if="x.isScholarship == 'activity'">
